                ...
                <ul class="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-12">
                    <li class="flex items-center cursor-pointer outline-none group">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path class="stroke-blue-600 transition-all duration-500 group-hover:stroke-blue-600"
                        ...
                        <span
                            class="font-normal text-lg leading-8 text-blue-600 ml-2 mr-3 transition-all duration-500 group-hover:text-blue-600">Finance</span>
                        <button
                            class="flex aspect-square h-6 rounded-full border border-blue-600  items-center justify-center font-manrope font-medium text-base text-blue-600  transition-all duration-500 group-hover:border-blue-600 group-hover:text-blue-600">8</button>

                    </li>

                    <li class="flex items-center cursor-pointer outline-none group">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path class="stroke-black transition-all duration-500 group-hover:stroke-blue-600"
                        ...
                        <span
                            class="font-normal text-lg leading-8 text-black pl-2 pr-3 transition-all duration-500 group-hover:text-blue-600">Management</span>
                        <span
                            class="w-6 h-6 rounded-full border border-gray-900 flex items-center justify-center font-manrope font-medium text-base text-gray-900 transition-all duration-500 group-hover:border-blue-600 group-hover:text-blue-600">3</span>
                    </li>
                    ...
                    <li class="flex items-center cursor-pointer outline-none group">
                        ...
                        <span
                            class="font-normal text-lg leading-8 text-black pl-2 pr-3 transition-all duration-500 group-hover:text-blue-600">Today’s
                            deal</span>
                        <span
                            class="w-6 h-6 rounded-full border border-gray-900 flex items-center justify-center font-manrope font-medium text-base text-gray-900 transition-all duration-500 group-hover:border-blue-600 group-hover:text-blue-600">1</span>
                    </li>
                </ul>
            ...
            <div class="grid grid-cols-12">
                <div class="col-span-12 md:col-span-3 w-full max-md:max-w-md max-md:mx-auto">
                    <div class="box rounded-xl border border-gray-300 bg-white p-6 w-full md:max-w-sm">
                        ...
                        <button
                            class="w-full py-2.5 flex items-center justify-center gap-2 rounded-full bg-blue-600 text-white font-semibold text-xs shadow-sm shadow-transparent transition-all duration-500 hover:bg-blue-700 hover:shadow-blue-200  ">
                    ...
                    <div class="mt-7 box rounded-xl border border-gray-300 bg-white p-6 w-full md:max-w-sm">
                        <div class="flex items-center justify-between w-full pb-3 border-b border-gray-200 mb-7">
                            ...
                            <p
                                class="font-medium text-xs text-gray-500 cursor-pointer transition-all duration-500 hover:text-blue-600">
                                RESET</p>
                        </div>
                        ...
                        <div class="w-full mb-7">
                            <div class='accordion-group grid grid-cols-1 gap-5 sm:gap-9'
                                ...
                                <div class='accordion '
                                    ...
                                    <button
                                        class='accordion-toggle group accordion-active:text-blue-600 inline-flex items-center justify-between leading-8 text-gray-600 w-full transition duration-500 hover:text-blue-600 active:text-blue-600'
                                        aria-controls='category-collapse-one'>
                                        <h5 class="font-medium text-sm text-gray-900">
                                            Availability
                                        </h5>
                                        <svg class='text-gray-900 transition duration-500 group-hover:text-blue-600 accordion-active:text-blue-600 accordion-active:rotate-180'
                        ...
                        <div class="box flex flex-col gap-2">
                            <div class="flex items-center">
                                <input id="checkbox-default-1" type="checkbox" value="" class="w-5 h-5 appearance-none border border-gray-300  rounded-md mr-2 hover:border-blue-500 hover:bg-blue-100 checked:bg-no-repeat checked:bg-center checked:border-blue-500 checked:bg-blue-100 checked:bg-[url('https://pagedone.io/asset/uploads/1689406942.svg')]">
